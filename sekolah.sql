...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Feb 2025 pada 02.12
...
CREATE TABLE `buku` (
  ...
  `cover_buku` varchar(1000) NOT NULL
...
INSERT INTO `siswa` (`id_siswa`, `nama`, `jenis_kelamin`, `alamat`) VALUES
(3, 'tata mehi eho', 'CEWO', 'supit urang');
